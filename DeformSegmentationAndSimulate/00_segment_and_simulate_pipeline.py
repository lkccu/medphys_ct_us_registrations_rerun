...
if __name__ == '__main__':
    ...
    # root_path_spines: E:\course\AIforMedicine\usct\medphys_ct_us_registration\01_training
    ...
    # root_path_vertebrae: E:\course\AIforMedicine\usct\medphys_ct_us_registration\dataset\vertebrae
    ...
    # list_file_name: E:\course\AIforMedicine\usct\medphys_ct_us_registration\DataGeneration_CT-US-Registration\DeformSegmentationAndSimulate\one_spine.txt
   ...
   # default 10
    ...
    # output folder: E:\course\AIforMedicine\usct\medphys_ct_us_registration\dataset\cropped_spine
    ...
    if 'crop_roi' in pipeline or 'all' in pipeline:
        subprocess.run(['python', './01_crop_ROI.py',
                        ...
                        "--out_path_spine", args.verse_path])
