...
def create_parser():
    ...
    parser.add_argument('--augment_test', action='store_true', help='augment test rawdata with rotation')
    parser.add_argument('--max_rotation', type=float, default=20, metavar='M', help='maximum rotation degree (default: 20)')
    parser.add_argument('--test_rotation_axis', type=str, choices=['x', 'y', 'z'], default=None, help='around which axis to rotate the rawdata [default: None]')
    parser.add_argument('--use_raycasted_data', action='store_true', help='train on raycasted')
    parser.add_argument('--no_augmentation', action='store_true', help='augment training rawdata')
    ...
    parser.add_argument('--occlude_data', action='store_true', help='occlude rawdata by removing points from the PC')
    parser.add_argument('--occlude_ratio', type=int, default=0, metavar='S', help='Percentage of rawdata to occlude')
